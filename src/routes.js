...
router.post('/bsi2/deeplink', async (req, res) => {
  try {
    const resource = req.body
	//routesDebug('routes.js -> post /deeplink')
	//routesDebug('req: \n')
	//routesDebug(req)
	//routesDebug('res: \n')
	//routesDebug(res)
	...
	const style = 'width: ' + resource.buttonStyle.width + 
		...
		'; margin: ' + resource.buttonStyle.margin +
	...
	const html = '<div><a href="' + resource.linkText + '" target="_blank" style="' + style + '" rel="noopener">' + resource.buttonText + "</a></div><br>";
